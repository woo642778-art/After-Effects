...
var products: [Product] = [
    ...
    .library(name: "VertexProcedural", targets: ["VertexProcedural"]),
...
var targets: [Target] = [
    ...
    .target(name: "VertexProcedural", dependencies: ["VertexCore"]),
    .target(name: "VertexRenderMetal", dependencies: ["VertexCore", "VertexMedia", "VertexRender", "VertexProcedural"], resources: [.process("Shaders")]),
    ...
    .testTarget(name: "VertexProceduralTests", dependencies: ["VertexProcedural", "VertexCore"]),
    .testTarget(name: "VertexRenderMetalTests", dependencies: ["VertexRenderMetal", "VertexRender", "VertexComposition", "VertexProject", "VertexMedia", "VertexCore", "VertexProcedural"]),

...
p=ROOT/"Tests/VertexAppTests/AIFrameEffectServiceTests.swift"; p.parent.mkdir(parents=True,exist_ok=True)
...
func obsoleteRequestsAreCancelled() async throws {
    ...
    #expect(await service.cachedImage(for: obsolete.key) == nil)
}
''')
print('Task 8 RED tests applied')

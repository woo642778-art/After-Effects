...
write("Tests/VertexCompositionTests/EffectGraphCompilerTests.swift", r'''import Foundation
import Testing
...
func effectParameterAnimationUsesExactTime() async throws {
    ...
    let evaluated = try #require(await effects.effects().first)

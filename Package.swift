...
let package = Package(
    ...
    products: [
        ...
        .library(name: "VertexProjectFoundation", targets: ["VertexProjectFoundation"]),
    ...
    targets: [
        ...
        .testTarget(
            name: "VertexProjectFoundationTests",
            dependencies: ["VertexProjectFoundation", "VertexProject", "VertexCore", "VertexMedia"]
        ),
        .testTarget(

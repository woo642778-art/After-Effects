...
let package = Package(
    ...
    products: [
        ...
        .library(name: "VertexTrackingVision", targets: ["VertexTrackingVision"]),
    ...
    targets: [
        ...
        .testTarget(name: "VertexTrackingVisionTests", dependencies: ["VertexTrackingVision", "VertexProject", "VertexCore"]),

...
@Test("Phase 9 is the active architecture milestone")
func phaseNineIsActive() {
    #expect(MilestoneCatalog.current.number == 9)
    #expect(MilestoneCatalog.current.title == "AE Workspace and Live AI Effects")

...
@Test("Phase 10 is the active architecture milestone")
func phaseTenIsActive() {
    #expect(MilestoneCatalog.current.number == 10)
    #expect(MilestoneCatalog.current.title == "iPad AE Workspace and 3D")

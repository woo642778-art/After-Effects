...
func invalidNavigationNormalizes() throws {
    ...
    let invalidComposition = VertexID(rawValue: "60000000-0000-0000-0000-000000000099")
    let invalidLayer = VertexID(rawValue: "60000000-0000-0000-0000-000000000098")
    let invalidMedia = VertexID(rawValue: "60000000-0000-0000-0000-000000000097")
    let document = makeDocument(
        compositions: [composition],
        layers: [],
        activeCompositionID: invalidComposition,
        selectedLayerID: invalidLayer,
        selectedMediaID: invalidMedia
    )
    let codec = DeterministicProjectCodec()

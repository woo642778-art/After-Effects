...
@Test("V17 compatibility audit preserves the full indexed reference count")
func compatibilityAuditTotalsRemainTruthful() throws {
    ...
    #expect(EffectCompatibilityAudit.implementedCount == 113)
    #expect(EffectCompatibilityAudit.remainingIndexedCount == 1_455)

...
func trackingTranslationSolve() throws {
    ...
    #expect(follow[0].keyframes.last?.value == .scalar(0.7))
    #expect(stabilize[0].keyframes.last?.value == .scalar(0.3))
    #expect(follow[1].keyframes.last?.value == .scalar(0.4))
    #expect(stabilize[1].keyframes.last?.value == .scalar(0.6))
}
...
func planarTrackingSolve() throws {
    ...
    #expect(follow[2].keyframes.last?.value == .scalar(1.5))
    #expect(follow[4].keyframes.last?.value == .scalar(25))
}

...
struct CompositionEffectResolverAdapter: CompositionEffectResolver {
    ...
    func resolve(_ request: CompositionEffectRequest) async throws -> PortableImage {
        do {
            ...
            let frameRequest = AIFrameEffectRequest(
                key: key,
            ...
            throw CompositionError.effectResolutionFailed(
                layerID: request.layerID.rawValue,
                effectID: request.effect.id.rawValue,
                effectType: request.effect.type.rawValue,
                time: request.exactCompositionTime.description,

...
public struct ProjectJournalRecord: Codable, Equatable, Sendable {
    ...
    private static func computeChecksum(sequence: UInt64, command: ProjectCommandRecord) throws -> String {
        ...
        do {
            ...
            throw ProjectError.deterministicEncodingFailure("Journal checksum payload could not be encoded: \(error.localizedDescription)")
        }
    }
...
public struct ProjectJournalCodec: Sendable {
    ...
    public func encodeLine(_ record: ProjectJournalRecord) throws -> Data {
        ...
        do {
            ...
            throw ProjectError.deterministicEncodingFailure("Journal record could not be encoded: \(error.localizedDescription)")
        }
    }
    ...
    public func decodeLine(_ line: Data) throws -> ProjectJournalRecord {
        ...
        do {
            ...
            throw ProjectError.journalCorruption("A complete journal line could not be decoded: \(error.localizedDescription)")
        }
    }
